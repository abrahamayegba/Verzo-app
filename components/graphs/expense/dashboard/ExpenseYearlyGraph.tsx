...
const ExpenseYearlyGraph = () => {
  ...
  const customTooltip = (props: any) => {
    ...
    return (
      <div className="w-[250px] rounded-tremor-default border border-tremor-border bg-tremor-background p-2 ml-[200px] mt-[-180px] text-tremor-default shadow-tremor-dropdown">
  ...
  return (
    <div className=" w-full">
      <AreaChart
        ...
        index="month"
        yAxisWidth={65}
        categories={["totalPendingExpensesAmount", "totalPaidExpensesAmount"]}
        colors={["green", "blue"]}
        showGridLines={false}
