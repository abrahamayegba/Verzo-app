...
interface YearlyExpenseTotalAmounts {
  month?: string | null;
  totalPaidExpensesAmount?: number | null;
}

const ExpenseDashboardPaidYearlyGraph = () => {
  ...
  const customTooltip = (props: any) => {
    ...
    return (
      <div className="w-[220px] rounded-tremor-default border border-tremor-border bg-tremor-background p-2 ml-[220px] mt-[-150px] text-tremor-default shadow-tremor-dropdown">
  ...
  return (
    <div className=" w-full">
      <AreaChart
        ...
        index="month"
        yAxisWidth={65}
        categories={["totalPaidExpensesAmount"]}
        colors={["green"]}
        showGridLines={false}
...
export default ExpenseDashboardPaidYearlyGraph;
