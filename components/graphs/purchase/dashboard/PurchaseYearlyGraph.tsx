  ...
  return (
    <div className=" w-full">
      <AreaChart
        ...
        index="month"
        yAxisWidth={65}
        categories={["totalPendingPurchasesAmount", "totalPaidPurchasesAmount"]}
        colors={["green", "blue"]}
        showGridLines={false}
...
export default PurchaseYearlyGraph;
