...
interface YearlyPurchaseTotalAmounts {
  month?: string | null;
  totalPendingPurchasesAmount?: number | null;
}

const PurchaseDashboardPendingYearlyGraph = () => {
  ...
  const customTooltip = (props: any) => {
    ...
    return (
      <div className="w-[250px] rounded-tremor-default border border-tremor-border bg-tremor-background p-2 ml-[180px] mt-[-150px] text-tremor-default shadow-tremor-dropdown">
  ...
  return (
    <div className=" w-full">
      <AreaChart
        ...
        index="month"
        yAxisWidth={65}
        categories={["totalPendingPurchasesAmount"]}
        colors={["red"]}
        showGridLines={false}
...
export default PurchaseDashboardPendingYearlyGraph;
