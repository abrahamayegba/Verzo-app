...
interface QuarterlyInvoiceTotalAmounts {
  ...
  invoicePending?: number | null | undefined;
}

const InvoiceDashboardPendingQuarterlyGraph = () => {
...
export default InvoiceDashboardPendingQuarterlyGraph;
