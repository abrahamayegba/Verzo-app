...
interface YearlyInvoiceTotalAmounts {
  ...
  totalPendingInvoicesAmount?: number | null | undefined;
}

const InvoiceDashboardPendingYearlyGraph = () => {
  ...
  const customTooltip = (props: any) => {
    ...
    return (
      <div className="w-[240px] rounded-tremor-default border border-tremor-border bg-tremor-background p-2 ml-[200px] mt-[-150px] text-tremor-default shadow-tremor-dropdown">
  ...
  return (
    <div className=" w-full">
      <AreaChart
        ...
        index="month"
        yAxisWidth={65}
        categories={["totalPendingInvoicesAmount"]}
        colors={["red"]}
        showGridLines={false}
...
export default InvoiceDashboardPendingYearlyGraph;
