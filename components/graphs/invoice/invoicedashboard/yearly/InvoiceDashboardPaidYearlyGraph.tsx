...
interface YearlyInvoiceTotalAmounts {
  ...
  totalPaidInvoicesAmount?: number | null | undefined;
}

const InvoiceDashboardPaidYearlyGraph = () => {
  ...
  const customTooltip = (props: any) => {
    ...
    return (
      <div className="w-[220px] rounded-tremor-default border border-tremor-border bg-tremor-background p-2 ml-[280px] mt-[-150px] text-tremor-default shadow-tremor-dropdown">
  ...
  return (
    <div className=" w-full">
      <AreaChart
        ...
        index="month"
        yAxisWidth={65}
        categories={["totalPaidInvoicesAmount"]}
        colors={["green"]}
        showGridLines={false}
...
export default InvoiceDashboardPaidYearlyGraph;
