...
const ArchiveService: React.FC<ArchiveServiceProps> = ({
  open,
  openModal,
  onClose,
  serviceId,
  ...
  const handleArchiveServiceClick = async () => {
    try {
            ...
            >
              <Dialog.Panel className="relative transform gap-y-3 overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow transition-all sm:w-full sm:max-w-[450px] sm:p-9">
                <div className=" flex flex-col gap-y-3">
                  ...
                  <p className=" text-lg text-[#121212]">Archive service</p>
                  <p className=" text-primary-greytext">
                    Are you sure you want to archive this service? It won’t be
                  ...
                  <div className=" flex justify-between mt-6">
                    ...
                    <button
                      type="button"
                      onClick={handleArchiveServiceClick}
