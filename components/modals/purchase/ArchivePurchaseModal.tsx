...
const ArchivePurchase: React.FC<ArchivePurchaseProps> = ({
  open,
  openModal,
  onClose,
  purchaseId,
  ...
  const showSuccessToast = () => {
    toast({
      title: "Archived!",
      description: "Your purchase order has been successfully archived",
      duration: 3500,
    });
  };
              ...
              <Dialog.Panel className="relative transform gap-y-3 overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow transition-all sm:w-full sm:max-w-[450px] sm:p-9">
                <div className=" flex flex-col gap-y-3">
                  ...
                  <p className=" text-primary-greytext">
                    Are you sure you want to archive this purchase order? It
                    won’t be visible till unarchive
                  </p>
...
export default ArchivePurchase;
