        ...
        <div className="tracking-[-0.3px] pt-[60px]">
            ...
            <div className="tracking-[-0.3px]">
                <div className="pb-12 pl-[100px] xl:pl-[140px]">
                    <h4 className="text-4xl font-medium text-primary-black height-normal pb-2">Sign in on Verzo</h4>
                    <p className="text-xl text-primary-greytext">Welcome back</p>
                </div>
                <form className="pl-[100px] xl:pl-[140px]">
                   ...
                   <div className="pb-9">
                        ...
                        <div className="relative w-[400px]">
                         <input type={showPassword ? 'text' : 'password'} name="password" className="w-[400px] h-[47px] pl-[14px] text-lg font-medium border-primary-mainGrey rounded-[8px] border-[1px] focus:outline-none placeholder:text-sm" placeholder="8+ characters" />
                         <span onClick={togglePasswordVisibility} className="absolute cursor-pointer top-[16px] right-[13px]">{showPassword ? <EyeOpenIcon/> : <EyeClosedIcon />}</span> 
                        </div>
                   </div>
                   <p className="text-base text-primary-black font-medium">Forgot password? <Link href="/reset-link" className="text-primary-blue font-normal">Reset here</Link></p>
                   <div className="pt-9">
