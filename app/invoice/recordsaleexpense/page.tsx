          ...
          {saleExpenses.map((expense) => (
            ...
            >
              ...
              <div className="text-primary-greytext flex flex-col gap-y-2">
                <p>Description</p>
                <input
                  className="w-full rounded-lg text-primary-black border border-gray-200 p-[10px] text-[15px] focus:outline-none"
                  type="text"
              ...
              <div className="text-primary-greytext flex flex-col gap-y-2">
                <p>Reference</p>
                <input
                  className="w-full text-primary-black rounded-lg border border-gray-200 p-[10px] text-[15px] focus:outline-none"
                  type="text"
